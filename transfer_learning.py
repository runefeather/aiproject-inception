...
def optimize(num_iterations, session, x, y_true, global_step, optimizer, accuracy, transfer_values_train, labels_train):
...
def predict_cls_test(session, x, y_true, y_pred_cls, transfer_values_test, labels_test, cls_test):
    return predict_cls(session=session, x=x, y_true= y_true, y_pred_cls=y_pred_cls, transfer_values = transfer_values_test,
                       labels = labels_test,
                       cls_true = cls_test)
...
def print_test_accuracy(session, x, y_true, y_pred_cls, transfer_values_test, labels_test, cls_test, show_example_errors=False, show_confusion_matrix=False):

    # For all the images in the test-set,
    # calculate the predicted classes and whether they are correct.
    correct, cls_pred = predict_cls_test(session, x, y_true, y_pred_cls, transfer_values_test, labels_test, cls_test)
...
def main(splitnum):
	...
	test, train, val = transfer.preprocessing("/home/runefeather/Desktop/Classwork/AI/Project/breakhissplits_v2/train_val_test_60_12_28/")
